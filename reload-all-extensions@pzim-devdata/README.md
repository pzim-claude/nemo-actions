...
Download [reload-all-extensions@pzim-devdata.zip](https://github.com/pzim-claude/nemo-actions/releases/latest/download/reload-all-extensions@pzim-devdata.zip), extract and copy contents:
